...
export class Migration20220704071531 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `project` (`_id` text not null, `created_at` datetime not null, `updated_at` datetime not null, `plant_id` text not null, `author__id` text not null, `type` text not null default 0, `data` text not null, constraint `project_author__id_foreign` foreign key(`author__id`) references `user`(`_id`) on update cascade, primary key (`_id`));');
