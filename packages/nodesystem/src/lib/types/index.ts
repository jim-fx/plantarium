import type {
  ...
  IntegerTemplate,
  SelectTemplate,
  ValueTemplate as _ValueTemplate,
} from '@plantarium/ui';
...
export type Params<T extends NodeParameters> = {
  [K in keyof T]: T[K] extends FloatTemplate
    ? number
    : T[K] extends IntegerTemplate
    ? number
    : T[K] extends CheckboxTemplate
    ? boolean
    : T[K] extends SelectTemplate
    ? string
    : unknown;
};
